              ...
              <div class="layered">
                <div class="layered-content">
                  <ul class="blog-list-sidebar">
                    <li>
                      <div class="post-thumb"> <a href="#"><img src="{{asset('public/fontEnd/images/')}}/blog-img1.jpg" alt="Blog"></a> </div>
                      <div class="post-info">
                    ...
                    <li>
                      <div class="post-thumb"> <a href="#"><img src="{{asset('public/fontEnd/images/')}}/blog-img2.jpg" alt="Blog"></a> </div>
                      <div class="post-info">
                        <h5 class="entry_title"><a href="#">Lorem ipsum dolor</a></h5>
                        <div class="post-meta"> <span class="date"><i class="fa fa-calendar"></i> 2014-08-05</span> <span class="comment-count"> <i class="fa fa-comment-o"></i> 3 </span> </div>
                      </div>
                    ...
                    <li>
                      <div class="post-thumb"> <a href="#"><img src="{{asset('public/fontEnd/images/')}}/blog-img3.jpg" alt="Blog"></a> </div>
                      <div class="post-info">
                        <h5 class="entry_title"><a href="#">Lorem ipsum dolor</a></h5>
                        <div class="post-meta"> <span class="date"><i class="fa fa-calendar"></i> 2014-08-05</span> <span class="comment-count"> <i class="fa fa-comment-o"></i> 3 </span> </div>
                      </div>
          ...
          <div class="single-img-add sidebar-add-slider">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <img src="{{asset('public/fontEnd/images/')}}/add-slide1.jpg" alt="slide1">
                ...
                <div class="item"> <img src="{{asset('public/fontEnd/images/')}}/add-slide2.jpg" alt="slide2">
                  <div class="carousel-caption">
                    <h3><a href="single_product.html" title=" Sample Product">Smartwatch Collection</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="info">All Collection</a> </div>
                </div>
                <div class="item"> <img src="{{asset('public/fontEnd/images/')}}/add-slide3.jpg" alt="slide3">
                  <div class="carousel-caption">
