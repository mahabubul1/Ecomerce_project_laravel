      ...
      <div class="row">
        <div class="col-md-9">
          <div class="card ">
              ...
              <div class="card-body ">   
              {!! Form::open(['url' => 'admin/Brand/save', "method"=>"POST"]) !!}
                <div class="form-group row">
                    {!! Form::label('brandName', 'Brand Name', ["class"=>"col-sm-2 col-form-label"]) !!}
                     <div class="col-sm-6">
                      {!! Form::text('brandName', null, ['class'=>'form-control']  ); !!} 
                      <div class="text-danger">{{$errors->has('brandName')?$errors->first("brandName"):""}}</div>  
                  ...
                  <div class="form-group row">
                    {!! Form::label('publicationStatus', 'Publication Status', ["class"=>"col-sm-2 col-form-label"]) !!}
                     <div class="col-sm-6">
                      ...
                      <div class="text-danger" style="margin-top:40px">{{$errors->has('publicationStatus')?$errors->first("publicationStatus"):""}}</div>  
              ...
              <div class="form-group row">
                <div class="col-sm-2"></div>
                 <div class="col-sm-6">
                     {!!Form::submit('save Brand Info',['class'=>'btn btn-rose']); !!}
                 </div>
              </div>
